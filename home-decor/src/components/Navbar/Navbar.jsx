  ...
  return (
    <Flex maxW={'100%'} p="5px 20px" zIndex={1} position="sticky" top="0" bgColor="#902735" justifyContent="space-between" color="white" marginBottom={3}>
      ...
      <Flex alignItems="center" display={{base : 'none', sm:'flex'}} gap={1}>
        <Text fontSize="lg" color="white">Search </Text>
        <Input value={searchText} onChange={(e)=>setSearchText(e.target.value)} type="text" bgColor="whiteAlpha.200" color="white" minW={{sm:"200px",md:"300px"}} _focus={{border : "2px solid red"}} />
        <Circle onClick={handleSearchClick} bgColor="whiteAlpha.500" p={2} border="1px solid white" cursor="pointer" _hover={{border :"1px solid red"}}>
