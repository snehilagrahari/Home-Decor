...
export const getCartItems = () => async (dispatch) => {
  ...
  try {
    let resp = await axios.get(
      "https://mock-server-ge69.onrender.com/api/CartItem"
    );
...
export const addItemToCart = (info) => (dispatch) => {
  ...
  return axios
    .post("https://mock-server-ge69.onrender.com/api/CartItem", {
      ...info,
      count: 1,
      fixed: info.price,
    })
...
export const removeItemFromCart = (cartId) => (dispatch) => {
  ...
  return axios
    .delete(`https://mock-server-ge69.onrender.com/api/CartItem/${cartId}`)
    .then((re) => {
...
export const updateCartItem = (cartId, update) => (dispatch) => {
  ...
  return axios
    .patch(`https://mock-server-ge69.onrender.com/api/CartItem/${cartId}`, {
      ...update,
    })
    .then(({ data }) => {
